...
- **触发词**: 「复盘」
- **执行要求**:
  1. 自动调用自我提升（self-improvement）技能
  2. 将复盘结论与改进点写入对应记忆文档持久保存
- **技能获取**: 先从 ClawHub/GitHub 搜索安装 self-improvement 技能

### 规则3: 禁止飞书插件与 OpenClaw 版本操作
- **内容**: 禁止安装任何飞书插件、禁止升级 OpenClaw 版本
- **原因**: 用户明确要求
- **执行要求**: 永不执行任何飞书插件安装/更新命令，永不执行 OpenClaw 版本升级
